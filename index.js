...
function IndeedData(link){
    ...
    .then(function(html){
        ...
        return { userId: '1', jobTitle :postTitle, location : lieu, nomEntreprise : companyName,typeDeContrat : typeContract, descriptionPost :description };
